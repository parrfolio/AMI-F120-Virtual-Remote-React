...
export const About = () => {
  return (
    <div className="min-h-screen bg-white">
      <div
        className={`container mx-auto px-4 py-8 ${LAYOUT_CONFIG.HEADER_CLEARANCE.ABOUT} ${LAYOUT_CONFIG.PLAYER_CLEARANCE.ABOUT}`}
      >
        ...
        <div className="prose max-w-none">
          <p className="text-lg text-gray-700 mb-4">
            This is a virtual remote control interface for the AMi F-120
            Jukebox. It allows you to control song selection and LED light
            animations via a web interface.
          </p>
